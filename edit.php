...
$sql="UPDATE empdetails SET firstname='$firstname',lastname='$lastname',email='$email',mobileno='$mobileno',address='$address',gender='$gender',hobby='$hobby',photo='$filename' WHERE id='{$id}'";
...
$sql="SELECT * FROM empdetails WHERE id={$id1}";
$result_update= mysqli_query($con,$sql) or die("Query Failed");


if(mysqli_num_rows($result_update)>0){
// $focus=[;
// $row1=mysqli_fetch_assoc($result_update);
...
?>
    ...
    <select name="countryCode" id="">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
            ...
            <input type="text" name="mobileno" value="<?php echo $row['mobileno'];?>" required><br/><br/>
            <label>Address:</label>
            ...
            Old Image
            <?php echo '<img src="upload/' . $row['photo'] . '" width="100px"/>';?>
                <br/><br/>
            <label>image:</label>
